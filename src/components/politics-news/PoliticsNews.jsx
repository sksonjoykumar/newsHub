...
import { politicsNews } from "../../news-api-data/potliticsNews";
import { ScaleLoader } from "react-spinners";
import { toast } from "react-toastify";
import Pagination from "../pagination/Pagination";

function PoliticsNews({ heading }) {
  ...
  const currentItems = Array.isArray(politicsNews)
    ? politicsNews.slice(startIndex, endIndex)
    : [];
  ...
  return (
    <>
      ...
      <Pagination
        totalItems={politicsNews.length || 0}
